...
function SheetContent({
  ...
  className="absolute top-4 right-4 opacity-70 transition-opacity hover:opacity-100 focus:ring-0 focus:outline-none disabled:pointer-events-none"
>
  <IoMdClose className="text-3xl text-[#39e629]" />
